...
<?php if($ryear=="2017") { ?>
    <div class="page">
        ...
        <label style="position:absolute;margin:250px 0px 0px 110px;"> ALL INDIA </label><br>
        <label style="position:absolute;margin:275px 0px 0px 300px;"> <?php echo "$cname"; ?> </label><br>
        <label style="position:absolute;margin:285px 0 0 220px;"> <?php echo "$rroll"; ?> </label><br>
        <label style="position:absolute;margin:300px 0 0 260px;"> <?php echo "$mname"; ?> </label><br>
        <label style="position:absolute;margin:310px 0 0 400px;"> <?php echo "$fname"; ?> </label><br>
        <label style="position:absolute;margin:325px 0 0 175px;"> <?php echo "$sch"; ?>&nbsp;-&nbsp;<?php echo "$abbr_name"; ?> </label><br>
