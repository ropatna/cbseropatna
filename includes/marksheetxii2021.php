...
<?php if($ryear=="2021") { ?>
    <div class="page">
        ...
        <label style="position:absolute;margin:780px 0 0 465px;"> <?php if($cat=="I" && $res=="XXXX"){echo "APPEARED FOR IMPROVEMENT";}elseif($cat=="A"){echo "APPEARED FOR ADDITIONAL SUBJECT";} else {echo "     ";} ?> </label><br>
