...
<div class="page"> 
    ...
    <?php } ?>
    <label style="position:absolute;margin:355px 0px 0px 143px;"> ALL INDIA </label><br>
    <label style="position:absolute;margin:400px 0px 0px 255px;"> <?php echo "$cname"; ?> </label><br>
    <label style="position:absolute;margin:435px 0px 0px 190px;"> <?php echo "$rroll"; ?> </label><br>
    <label style="position:absolute;margin:465px 0px 0px 280px;"> <?php echo "$mname"; ?> / <?php echo "$fname"; ?> </label><br>
    <label style="position:absolute;margin:455px 0px 0px 410px;">  </label><br>
    <label style="position:absolute;margin:545px 0px 0px 160px;"> <?php echo "$sch"; ?> - <?php echo "$abbr_name"; ?> </label><br>

    <div style="display: grid;grid-template-columns: 200px 200px 200px;margin:620px 0px 0px 70px;position:absolute;">
    ...
    <label style="position:absolute;margin:880px 0px 0px 120px;"> PATNA </label><br>
    <label style="position:absolute;margin:900px 0px 0px 120px;"> <?php echo "$newDateDecl"; ?> / <?php echo "$newDateUpd"; ?></label>
</div>
<?php } ?>
