...
<div class="page">
    ...
    <div style="display: grid;grid-template-columns: 60px 255px 60px 60px 60px 150px auto;margin:510px 0px 0px 60px;position:absolute;">
        ...
        <div style="padding: 5px;font-size: 13px;text-align: left;grid-column: 2 / 7;" <?php if($isub1==null){echo "hidden";} ?>><?php echo "$isname1"; ?></div>
        ...
        <div style="padding: 5px;font-size: 13px;text-align: left;grid-column: 2 / 7;" <?php if($isub2==null){echo "hidden";} ?>><?php echo "$isname2"; ?></div>
        ...
        <div style="padding: 5px;font-size: 13px;text-align: left;grid-column: 2 / 7;" <?php if($isub3==null){echo "hidden";} ?>><?php echo "$isname3"; ?></div>
...
<div class="page">
    ...
    <?php } ?>
    <label style="position:absolute;margin:80px 0px 0px 620px;"> <?php if($doctype=="dublicate"){ echo "DUPLICATE"; } if($doctype=="correction"){ echo "REVISED"; } ?> </label><br>
    <label style="position:absolute;margin:261px 0px 0px 120px;"> ALL INDIA </label><br>
    <label style="position:absolute;margin:285px 0px 0px 310px;"> <?php echo "$cname"; ?> </label><br>
    <label style="position:absolute;margin:295px 0 0 195px;"> <?php echo "$rroll"; ?> </label><br>
    <label style="position:absolute;margin:310px 0 0 265px;"> <?php echo "$mname"; ?> </label><br>
    <label style="position:absolute;margin:320px 0 0 385px;"> <?php echo "$fname"; ?> </label><br>
    <label style="position:absolute;margin:330px 0 0 175px;"> <?php echo "$sch"; ?>&nbsp;-&nbsp;<?php echo "$abbr_name"; ?> </label><br>

    <div style="display: grid;grid-template-columns: 60px 230px 50px 60px 60px 150px auto;margin:415px 0px 0px 60px;position:absolute;">
