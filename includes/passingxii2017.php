...
<div class="page">
    ...
    <?php } ?>
    <label style="position:absolute;margin:335px 0px 0px 143px;"> ALL INDIA </label><br>
    <label style="position:absolute;margin:385px 0px 0px 255px;"> <?php echo "$cname"; ?> </label><br>
    <label style="position:absolute;margin:420px 0px 0px 200px;"> <?php echo "$rroll"; ?> </label><br>
    <label style="position:absolute;margin:435px 0px 0px 270px;"> <?php echo "$mname"; ?></label><br>
    <label style="position:absolute;margin:455px 0px 0px 400px;"> <?php echo "$fname"; ?> </label><br>
    <label style="position:absolute;margin:530px 0px 0px 160px;"> <?php echo "$sch"; ?> - <?php echo "$abbr_name"; ?> </label><br>

    <div style="display: grid;grid-template-columns: 200px 200px 200px;margin:610px 0px 0px 70px;position:absolute;">
    ...
    <label style="position:absolute;margin:890px 0px 0px 150px;"> PATNA </label><br>
    <label style="position:absolute;margin:900px 0px 0px 150px;"> <?php echo "$newDateDecl"; ?> / <?php echo "$newDateUpd"; ?></label>
</div>
<?php } ?>
